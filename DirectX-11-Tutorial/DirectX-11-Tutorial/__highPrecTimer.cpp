...
bool HighPrecisionTimer::Initialize(const float &interval)
{
...
// change interval so we can manage time flow of the application
void HighPrecisionTimer::reInitialize(const float &interval)
{
    m_Interval = interval * m_ticksPerMs;
}
// ------------------------------------------------------------------------------------------------------------------------
